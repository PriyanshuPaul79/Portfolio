            ...
            <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-1 gap-5 h-full overflow-x-hidden'>
                <div className='col-span-1 xl:row-span-3 '>
                    <div className='grid-container'>
                        <img src="/assets/Me.jpg" alt="Me" className='w-full sm:h-[276px] h-[600px] object-contain ' />
                        <div>
                ...
                <div className='col-span-1 xl:row-span-4 '>
                    <div className='grid-container'>
                        ...
                        <button
                            onClick={() => window.open("https://github.com/PriyanshuPaul79", "_blank")}
                            className="flex items-center gap-2 px-4 py-4 mt-12 bg-gray-900 text-white rounded-lg hover:bg-gray-700 transition"
                        >
                            <FaGithub size={20} />
                            Check my GitHub
                        </button>
                        ...
                        <button
                            onClick={() => window.open("https://www.linkedin.com/in/priyanshu-paul-77735524p/", "_blank")}
                            className="flex items-center gap-2 px-4 py-4 mt-6 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition"
                        >
                            <FaLinkedin size={20} />
                            Check my LinkedIn
                        </button>
